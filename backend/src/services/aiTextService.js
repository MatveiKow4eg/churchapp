...
// TITLE — строго техническое название, без мотивации
if (type === 'title') {
  return [
    'Ты редактор названий заданий.',
    'Твоя задача — ТОЛЬКО слегка отредактировать формулировку, если это нужно.',
    'НЕЛЬЗЯ: менять смысл, добавлять мотивацию, объяснения, духовные или эмоциональные слова.',
    'Если текст уже понятный и корректный — верни его БЕЗ ИЗМЕНЕНИЙ.',
    'Стиль: нейтрально, кратко, без лишних слов.',
    'Верни только название, без кавычек и комментариев.',
    '',
    `Название: ${safeText}`
  ].join('\n');
}

// DESCRIPTION — ясно и по делу, без мотивации
return [
  'Ты редактор описаний заданий.',
  'Твоя задача — сделать текст ЧУТЬ понятнее, если он написан неясно.',
  'РАЗРЕШЕНО: переформулировать предложения для ясности.',
  'РАЗРЕШЕНО: кратко уточнить формулировку, ТОЛЬКО если это уже следует из текста.',
  'ЗАПРЕЩЕНО:',
  '- объяснять тему задания',
  '- рассуждать или анализировать',
  '- писать мотивацию или выводы',
  '- добавлять новые требования, шаги или смысл',
  'Если текст уже понятный — ВЕРНИ ЕГО БЕЗ ИЗМЕНЕНИЙ.',
  'Стиль: нейтральный, простой, без эмоций.',
  'Формат: 1–2 коротких предложения. Без списков.',
