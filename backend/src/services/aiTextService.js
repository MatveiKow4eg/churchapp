...
return [
  ...
  'Твоя задача — сделать описание более понятным и читаемым.',
  'РАЗРЕШЕНО: слегка переформулировать текст, объединить или разделить предложения для ясности.',
  'РАЗРЕШЕНО: кратко пояснить, что имеется в виду, ЕСЛИ это уже следует из исходного текста.',
  'ЗАПРЕЩЕНО: добавлять мотивацию, духовные рассуждения, объяснение «зачем», новые требования или шаги.',
  'Если текст уже понятный — верни его без изменений.',
  'Стиль: нейтральный, простой, без эмоций. 1–3 предложения. Без списков.',
