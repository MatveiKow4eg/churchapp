...
return [
  ...
  'Можно: добавить 1–2 коротких предложения, которые уточняют смысл и помогают понять, что делать.',
  'НЕЛЬЗЯ: добавлять новые требования, шаги, ограничения, сроки, цифры или детали, которых нет в исходном тексте.',
  'Стиль: дружелюбно, просто, без канцелярита. 2–4 предложения. Без списков. Без эмодзи.',
